            ...
            <div class="row col-sm-offset-1 col-md-offset-1 col-lg-offset-1" style="padding-top:20px;">
                <div class="col-sm-2 col-md-2 col-lg-2 ">
                    <div class="list-group" style="border-color: #9E1030; color: whitesmoke">
                        ...
                        <a href="EmployeeDetailed.aspx" class="list-group-item" style="border-top-width: 1px; border-bottom-width: 1px; border-right-color: #9E1030; border-right-width: 3px; border-left-color: #9E1030; border-left-width: 3px;">
                            <h6 class="list-group-item-heading" style="color: #9E1030;">Purchase Detailes</h6>
                        </a>
                        <a href="EmployeeSummary.aspx" class="list-group-item" style="border-top-width: 1px; border-bottom-width: 3px;border-bottom-color: #9E1030; border-right-color: #9E1030; border-right-width: 3px; border-left-color: #9E1030; border-left-width: 3px;">
                ...
                <div class="col-sm-2 col-md-2 col-lg-2 ">
                    <div class="list-group" style="border-color: #9E1030; color: whitesmoke">
                        ...
                        <a href="SoldItemsDetails.aspx" class="list-group-item" style="border-top-width: 1px; border-bottom-color: #9E1030;  border-right-color: #9E1030; border-right-width: 3px; border-left-color: #9E1030; border-left-width: 3px;">
                            <h6 class="list-group-item-heading" style="color: #9E1030;"> Sold Item Details</h6>
                        </a>
                        <a href="ItemTransactionSummary.aspx" class="list-group-item" style="border-top-width: 1px; border-bottom-color: #9E1030; border-bottom-width: 3px; border-right-color: #9E1030; border-right-width: 3px; border-left-color: #9E1030; border-left-width: 3px;">

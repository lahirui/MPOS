...
namespace MPOSReports.WebForms
{
    public partial class EmployeeSummary : System.Web.UI.Page
    {
        ...
        protected void btnDetails_Click(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/RDLC/PurchaseSummaryDS.rdlc");
            PurchaseSummaryDS Services = dbQuery.getPurchaseSummaryDetails(FactoryID, FromDate, ToDate);
            ReportDataSource DTSource = new ReportDataSource("PurchaseSummaryDS", Services.Tables[0]);

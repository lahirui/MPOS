<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmployeeDetailed.aspx.cs" Inherits="MPOSReports.WebForms.EmployeeDetailed" %>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="col-md-4" style="padding-top: 5px;">
                        <label id="Label5" runat="server">Employee</label>
                    </div>
                    <div class="col-md-1">
                        <asp:DropDownList ID="ddlEmployee" runat="server" CssClass="form-control" Width="180px" AppendDataBoundItems="true">
                            <Items>

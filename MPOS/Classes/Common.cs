...
namespace MPOS
{
    public class Common
    {
        ...
        public string constr = ConfigurationManager.ConnectionStrings["MPOSConStr"].ConnectionString;
        ...
        public DataTable ReturnDataTable(string strSqlCommand) //method to return data from database to form
        {
            SqlCommand sqlCmd = default(SqlCommand);
            SqlDataAdapter daComman = new SqlDataAdapter();
            DataTable dtComman = new DataTable();
